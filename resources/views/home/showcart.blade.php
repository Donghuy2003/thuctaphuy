...
<html>
   ...
   <body>
      ...
      <table>
         ...
         <div>
            <h1 style="color: red" class="total_deg">Total Price: ${{ $totalprice }}</h1>
         </div>
         <div>

            <h1 style="font-size: 25px; padding-bottom: 15px; padding-top:15px; color:blue;">PROCEED TO ORDER</h1>
